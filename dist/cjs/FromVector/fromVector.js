...
exports.FromVector = exports.createVector = void 0;
/**
 * Structure and logic are based on p5js.
 */
const createVector = (x, y, z = 0) => {
    const vectorObject = {
        isVectorObject: true,
        x, y, z,
        /**
        ...
        */
        ...
        copy() {
            return (0, exports.createVector)(this.x, this.y, this.z);
        },
        dist(x, y = 0) {
            if (x.isVectorObject) {
...
exports.FromVector = { create: exports.createVector };
