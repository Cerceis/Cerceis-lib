...
exports.Is = {
    ...
    falseValue: (x) => {
        let emptyCount = 0;
        if (exports.Is.emptyString(x))
            emptyCount++;
        if (exports.Is.number(x) && x === 0)
            emptyCount++;
        if (exports.Is.null(x))
            emptyCount++;
        if (exports.Is.undefined(x))
            emptyCount++;
        if (exports.Is.boolean(x) && x === false)
            emptyCount++;
