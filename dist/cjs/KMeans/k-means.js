...
const from_array_js_1 = require("../FromArray/from-array.js");
const KMeans = (k = 2, arr, attempts = 1) => {
    ...
    const smallestVariantScoreIndex = from_array_js_1.FromArray.getSmallest(variationScores, 1, true);
...
const CalculteDistances = (clusters, arr) => {
    arr.forEach(point => {
        ...
        const nearestPointIndex = from_array_js_1.FromArray.getSmallest(distances, 1, true);
