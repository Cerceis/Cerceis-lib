...
exports.cDate = exports.FromTime = exports.isDateObject = void 0;
...
class cDate {
    constructor(date) {
        if ((0, exports.isDateObject)(date))
            this._date = exports.FromTime.format(date, { asObject: true });
        else
            this._date = exports.FromTime.format(new Date(date), { asObject: true });
    }
    // AddData
    addMonth(n) {
        var _a;
        ...
        this._date = exports.FromTime.format(_d, { asObject: true });
    }
    get dateTime() {
